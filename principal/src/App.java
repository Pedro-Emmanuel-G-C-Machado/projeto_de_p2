...
public class App{
    public static void  main(String args[]) {
     ...
     // personagem amigo do exercito 
      ...
      capitulo_0.setNarrativa ( "Bem, senhor(a):" + player1.name + ", você  quer ser de qual  força armada, infelizmente  temos vagas apenas para o exercito e a marinha, qual é a sua escoolha, O exercito ou a marinha ? ");
      
      Capitulos capitulo_1 = new Capitulos(player1, texto);
      capitulo_1.setNarrativa( "Bom, aqui o senhor(a): " + player1.name + ", vai para os testes de aptidao fisica tem que fazer cinco flexoes, tres barras e vinte abdominais. Voce quer fazer agora ou deixar para amanha ? O que voce quer, hoje ou amanha ?");
      Capitulos capitulo_1_1 = new Capitulos(player1,texto);
      capitulo_1_1.setNarrativa( "Voce estava descansado, mas não conseguiu fazer os exercicios, você vai ter que ir embora filho.");
      Capitulos capitulo_1_2 = new Capitulos(player1, texto); 
      capitulo_1_2.setNarrativa( "Voce estava preparado para fazer todos os exercicios e foi para o escritorio assinar o contrato para ser encaminhado para o treinamento. Parabens," + player1.name + " ,voce esta no airborn, cia 22°, bem vindo ao exercito.");
      
      
      Capitulos capitulo_2 = new Capitulos(player1, texto);
        capitulo_2.setNarrativa("Certo, voce tem que fazer teste de apitidao fisica, sao dois quilometros de corrida, " +
        " tres quilometros e meio de natcao no mar, tres barras e quarenta abdominais."
         + "Voce quer fazer  hoje ou  amanha ?");
          ...
          capitulo_2_1.setNarrativa("Voce ficou com uma boa disposicao, e conseguiu nadar e correr" + 
          ...
          capitulo_2_2.setNarrativa("Você estava enfadado de mais para"+
          ...
          capitulos_3.setNarrativa("Depois do treinamento de paraquedista, voce conheceu "
          + player3.name +
          ...
          " o seu oficial  fazendo movimentos com as maos para"+
           ...
           capitulo_3_1.setNarrativa("Voce descidiu ajudar o " 
           + player3.name 
          ...
          capitulo_3_1.setAlteracaoDeEnergia(5);
          
              Capitulos capitulo_3_2 = new Capitulos(player1, texto);
          capitulo_3_2.setNarrativa ( "Voce foi para a beira do aviao decidido em saltar, mas se arrempedeu e quiz voltar e quando você estava se aproximando dele, o aviao explode e voces dois morrem junto com o piloto");



          Capitulos capitulo_4 = new Capitulos(player1, texto);
          capitulo_4.setNarrativa (	"Durante o treinamento voce fica amigo" 
          + player2.name 
       ...
       capitulo_4_1.setNarrativa ( "Voce seguiu a sugestao dele e destruiu de vez o aviao, mas a batalha ainda nao tinha acabado e com isso voce "
      ...
      + " situacao com isso voces dois recebe uma ordem de ir para o paiol para pegar mais municao, so que voce ouve mais um explosao"
       ...
       capitulo_4_2.setNarrativa ( "Voce seguiu seu pensamento e não destruiu, o aviao caiu no conves do navio nao explodiu"
     ...
     capitulo_4.adicionarEscolhas("poupar" , capitulo_4_2);
